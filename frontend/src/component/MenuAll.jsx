...
// Import del componente Card separato
...
const MenuAll = ({ onBack, onOpenReviews }) => {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col font-sans">
      ...
      {/* TopBar Header con Freccia Indietro, Informazioni Tavolo e Pulsanti d'Azione */}
      <header className="sticky top-0 z-30 bg-neutral-950/80 backdrop-blur-md border-b border-neutral-800 px-6 py-4 flex items-center justify-between">
        ...
        {/* Area destra Header: Pulsante Recensioni + Barra di Ricerca */}
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Griglia Piatti con Componente Separato Card */}
