...
const MenuAll = ({ onBack, onOpenReviews }) =>
{
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col font-sans">
      ...
      {/* Freccia + riquadro: il riquadro si apre orizzontalmente a sinistra della freccia */}
      <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">

        {/* Piccolo riquadro con carrello e recensioni, si apre a sinistra */}
        <div
        ...
        {/* Freccia per aprire/chiudere il riquadro */}
        <button
